...
public interface ScoreRepository extends CrudRepository<ScoreCard, Long> {
    ...
    /**
     * Gets the titak score for a given user: the sum of the scores of all ther ScoreCards.
     *
    ...
    /**
     * Retreives a list of {@link LeaderBoardRow}s representing the Leader Board
    ...
    /**
     * Retreives all the ScoreCards for a given user, identified by his user id.
     *
     * @param userId the id of the user
